...
stabilizer_type = "plate";  // [pcb, plate]
...
mcu_pin_count = 30;
mcu_pin_pitch = 2.54;
mcu_pin_offset = 3.5;  // Offset from the rear of the PCB
...
standoff_attachment_default = "backplate";  // [plate, backplate, pcb, plate_backplate, none]
